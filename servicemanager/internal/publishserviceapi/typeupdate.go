...
func (sd *ServiceAPIDescription) createKongService(
	...
	kongRouteUri, statusCode, err := sd.createRouteForService(kongControlPlaneURL, client, resource, routeName, uri, uriPrefix, tags, foundRegEx)
	if err != nil {
		log.Errorf(err.Error())
		return kongRouteUri, statusCode, err
	}
...
func (sd *ServiceAPIDescription) createRouteForService(
	...
	kongRouteUri := prependUri(uriPrefix, uri)
	log.Debugf("createRouteForService, kongRouteUri with uriPrefix %s", kongRouteUri)
