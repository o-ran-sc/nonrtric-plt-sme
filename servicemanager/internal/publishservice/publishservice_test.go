...
func TestPublishUnpublishWithoutVersionId(t *testing.T) {
	...
	assert.Equal(t, "/helloworld-v1/04478a3a-d0ef-5a05-a575-db5ee2e33403/helloworld", resource.Uri)
}
...
func TestPublishUnpublishVersionId(t *testing.T) {
	...
	assert.Equal(t, "~/helloworld-v1-id/04478a3a-d0ef-5a05-a575-db5ee2e33403/helloworld/v1/(?<helloworld-id>[a-zA-Z0-9]+([-_][a-zA-Z0-9]+)*)", resource.Uri)
}
...
func TestPublishUnpublishServiceNoVersionWithId(t *testing.T) {
	...
	assert.Equal(t, "~/helloworld-no-version/04478a3a-d0ef-5a05-a575-db5ee2e33403/helloworld/(?<helloworld-id>[a-zA-Z0-9]+([-_][a-zA-Z0-9]+)*)", resource.Uri)
