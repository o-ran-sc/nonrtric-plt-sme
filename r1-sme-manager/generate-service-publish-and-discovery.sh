...
spec_extraction () {
    ...
    echo "Zip extraction"
    unzip apidef.zip
    unzip common29122apidef.zip
    unzip common29508apidef.zip
    unzip common29510apidef.zip
    unzip common29512apidef.zip
    unzip common29514apidef.zip
    unzip common29517apidef.zip
    unzip common29518apidef.zip
    unzip common29522apidef.zip
    unzip common29523apidef.zip
    unzip common29554apidef.zip
    unzip common29571apidef.zip
    unzip common29572apidef.zip
}
