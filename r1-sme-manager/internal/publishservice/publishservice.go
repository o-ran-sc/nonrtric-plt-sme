...
func (ps *PublishService) PostApfIdServiceApis(ctx echo.Context, apfId string) error {
	log.Infof("entering PostApfIdServiceApis apfId %s", apfId)
	...
	if (err != nil) || (statusCode != http.StatusCreated) {
		...
		msg := err.Error()
		log.Infof("error on RegisterKong %s", msg)
	...
	log.Info("Calling PostApfIdServiceApisWithResponse")
	...
	if rsp.StatusCode() != http.StatusCreated {
		msg := string(rsp.Body)
		log.Infof("PostApfIdServiceApisWithResponse status code %d", rsp.StatusCode())
		log.Infof("PostApfIdServiceApisWithResponse error %s", msg)
...
func (ps *PublishService) DeleteApfIdServiceApisServiceApiId(ctx echo.Context, apfId string, serviceApiId string) error {
	log.Infof("entering DeleteApfIdServiceApisServiceApiId apfId %s serviceApiId %s", apfId, serviceApiId)
	...
	log.Infof("Call GetApfIdServiceApisServiceApiIdWithResponse before delete apfId %s serviceApiId %s", apfId, serviceApiId)
	...
	if statusCode != http.StatusOK {
		log.Infof("GetApfIdServiceApisServiceApiIdWithResponse status %d", statusCode)
	...
	log.Info("Call DeleteApfIdServiceApisServiceApiIdWithResponse")
...
func (ps *PublishService) GetApfIdServiceApis(ctx echo.Context, apfId string) error {
	log.Infof("entering GetApfIdServiceApis apfId %s", apfId)
	...
	if rsp.StatusCode() != http.StatusOK {
		msg := string(rsp.Body)
		log.Infof("GetApfIdServiceApisWithResponse status %d", rsp.StatusCode())
		log.Infof("GetApfIdServiceApisWithResponse error %s", msg)
		return sendCoreError(ctx, rsp.StatusCode(), msg)
	}
...
func (ps *PublishService) GetApfIdServiceApisServiceApiId(ctx echo.Context, apfId string, serviceApiId string) error {
	log.Infof("entering GetApfIdServiceApisServiceApiId apfId %s", apfId)
...
func (ps *PublishService) PutApfIdServiceApisServiceApiId(ctx echo.Context, apfId string, serviceApiId string) error {
	log.Infof("entering PutApfIdServiceApisServiceApiId apfId %s", apfId)
	...
	if rsp.StatusCode() != http.StatusOK {
		log.Infof("PutApfIdServiceApisServiceApiIdWithResponse status code %d", rsp.StatusCode())
