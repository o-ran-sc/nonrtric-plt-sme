...
create_env_from_template(){
    ...
    sed -i 's/R1_SME_MANAGER_PORT=<port number>/R1_SME_MANAGER_PORT=8095/' .env
...
update_r1_sme_manager_manifest(){
    echo "update_r1_sme_manager_manifest"
    # The below Docker image is not available at the time of writing. You will need to refer to your own build.
    # sed -i 's/REPLACE_ME/o-ran-sc.org/nonrtric/plt/r1-sme-manager:latest/' ../manifests/r1-sme-manager.yaml
}
...
kubectl create -f ../manifests/r1-sme-manager.yaml
